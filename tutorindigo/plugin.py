...
config: t.Dict[str, t.Dict[str, t.Any]] = {
    ...
    "defaults": {
        "VERSION": __version__,
        "WELCOME_MESSAGE": "Место для всего вашего онлайн-обучения",
        "PRIMARY_COLOR": "#7A5FA6",  # Indigo
        ...
        "FOOTER_NAV_LINKS": [
            ...
            {"title": "Блог", "url": "/blog"},
            {"title": "Условия использования", "url": "/tos"},
            {"title": "Политика конфиденциальности", "url": "/privacy"},
            {"title": "Помощь", "url": "/help"},
            {"title": "Связаться с нами", "url": "/contact"},
        ],
    },
    "unique": {},
    "overrides": {},
